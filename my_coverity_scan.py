...
# For a full list of options, pass the '--help' switch.
	...
	--source-dir			 // used for lock file
	--solution-file
	--solution-dir                  // derive
	--coverity-bin-dir              // derive
	--coverity-intermediate-dir     // default  
	--coverity-analyze-options      // default 
	--coverity-db-host              // remote host    
	--coverity-db-port              // port 
	--coverity-product 
	--coverity-target   ?
	--coverity-user
	--coverity-password-file
...
"""
SOURCE_DIR = 'C:\\juliet'
SOLUTION_DIR = 'src\\build'		      # Relative path
SOLUTION_FILE = 'src\\build\\juliet.sln'     # Relative path 
COVERITY_BIN_DIR = 'C:\\coverity\\prevent-win32-4.5.1\\bin'
COVERITY_INTERMEDIATE_DIR = 'C:\\coverity\\cvbuild\\cr_int'
"""

SOURCE_DIR = os.getcwd()  # Get your current working directly
print(SOURCE_DIR)
SOLUTION_DIR = './build'           # Relative path
SOLUTION_FILE = './juliet.sln'     # Relative path 
COVERITY_BIN_DIR = 'C:\\coverity\\prevent-win32-4.5.1\\bin'
COVERITY_INTERMEDIATE_DIR = 'C:\\coverity\\cvbuild\\cr_int'
...
COVERITY_USER = 'admin'
LOCK_FILE = 'coverity.lock' # # Relative to SOURCE_DIR.  (pid of this script)
